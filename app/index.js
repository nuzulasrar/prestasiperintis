...
library.add(fab, faPlus, faSquare, faArrowLeft, faChevronRight, faRightToBracket)
...
export default function Page() {
    ...
    return (
        ...
        <View className="flex-1 justify-center items-center">
            ...
            <Image source={require("../assets/logo.png")} style={{ width: 150, height: 150 }} className="mb-[50px]" />

            <Text className="mb-[50px] text-[20px] font-bold text-center mx-[50px]">Prestasi Perintis Plaza And Bridge Checklist</Text>

            <TouchableOpacity onPress={() => router.push({
                pathname: "/home",
                params: { id: 'bacon', name: "Ahmad" }
            })} className="p-2 bg-emerald-600 w-1/2 rounded-full justify-center items-center ">
                <Text className="text-white font-semibold text-[24px] text-center">Login</Text>
            </TouchableOpacity>
            {/* <TouchableOpacity onPress={() => router.push({
                pathname: "/about",
                params: { id: 'bacon', name: "Ahmad" }
